...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("MakimaDevil.modules." + module_name)
...
def send_help(chat_id, text, keyboard=None):
    ...
    dispatcher.message.bot.send_photo(
        chat_id=chat_id, START_IMG, caption=text, parse_mode=ParseMode.MARKDOWN, reply_markup=keyboard
    )
...
def makimamain_about_callback(update, context):
    ...
    if query.data == "makimamain_":
        query.message.edit_caption(
            caption=""" 📌 I'm *ᴍᴀᴋɪᴍᴀ*, a powerful group management bot built to help you manage your group easily.
