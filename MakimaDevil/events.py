...
from MakimaDevil import telethn
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import MakimaDevil.events

        path = Path(f"MakimaDevil/modules/{shortname}.py")
        name = "MakimaDevil.modules.{}".format(shortname)
        ...
        mod.MakimaDevil = MakimaDevil
        mod.tbot = telethn
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["MakimaDevil.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "MakimaDevil/modules/*.py"
