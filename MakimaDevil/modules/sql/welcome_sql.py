...
from MakimaDevil.modules.sql import BASE, SESSION
...
DEFAULT_WELCOME_MESSAGES = [
    ...
    "{first} just joined. Evermakimatelethon, look busy!",
    ...
    "Evermakimatelethon stop what you’re doing, We are now in the presence of {first}.",
    ...
    "{first}, do you know Kamisamas of death love apples?",  # Death Note owo
...
DEFAULT_GOODBYE_MESSAGES = [
    ...
    "Think for yourself",
    "Question authority",
    "You are worshiping a sun Kamisama",
