...
from MakimaDevil import dispatcher, LOGGER, DEVILS
from MakimaDevil.modules.disable import DisableAbleCommandHandler
from MakimaDevil.modules.helper_funcs.handlers import MessageHandlerChecker
from MakimaDevil.modules.helper_funcs.chat_status import user_admin
from MakimaDevil.modules.helper_funcs.extraction import extract_text
from MakimaDevil.modules.helper_funcs.filters import CustomFilters
from MakimaDevil.modules.helper_funcs.misc import build_keyboard_parser
from MakimaDevil.modules.helper_funcs.msg_types import get_filter_type
from MakimaDevil.modules.helper_funcs.string_handling import (
    split_quotes,
    button_markdown_parser,
    escape_invalid_curly_brackets,
    markdown_to_html,
)
from MakimaDevil.modules.sql import cust_filters_sql as sql
...
def rmall_filters(update, context):
    ...
    if member.status != "creator" and user.id not in DEVILS:
...
def rmall_callback(update, context):
    ...
    if query.data == "filters_rmall":
        if member.status == "creator" or query.from_user.id in DEVILS:
