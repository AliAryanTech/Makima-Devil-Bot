...
from MakimaDevil.modules.disable import DisableAbleMessageHandler
from MakimaDevil.modules.helper_funcs.regex_helper import infinite_loop_check
    ...
    if sed_result and update.effective_message.reply_to_message:
        ...
        try:
            ...
            if check and check.group(0).lower() == to_fix.lower():
                update.effective_message.reply_to_message.reply_text(
                    "Hey evermakimatelethon, {} is trying to make "
