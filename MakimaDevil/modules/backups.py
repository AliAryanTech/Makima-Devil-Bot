...
import MakimaDevil.modules.sql.notes_sql as sql
from MakimaDevil import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from MakimaDevil.__main__ import DATA_IMPORT
from MakimaDevil.modules.helper_funcs.chat_status import user_admin
from MakimaDevil.modules.helper_funcs.alternate import typing_action

# from MakimaDevil.modules.rules import get_rules
import MakimaDevil.modules.sql.rules_sql as rulessql

# from MakimaDevil.modules.sql import warns_sql as warnssql
import MakimaDevil.modules.sql.blacklist_sql as blacklistsql
from MakimaDevil.modules.sql import disable_sql as disabledsql

# from MakimaDevil.modules.sql import cust_filters_sql as filtersql
# import MakimaDevil.modules.sql.welcome_sql as welcsql
import MakimaDevil.modules.sql.locks_sql as locksql
from MakimaDevil.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("MakimaDevil{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("MakimaDevil{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `MakimaDevil-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("MakimaDevil{}.backup".format(chat_id))  # Cleaning file
