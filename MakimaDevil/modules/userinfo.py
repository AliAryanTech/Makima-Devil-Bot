...
from MakimaDevil.__main__ import STATS, TOKEN, USER_INFO
import MakimaDevil.modules.sql.userinfo_sql as sql
from MakimaDevil.modules.disable import DisableAbleCommandHandler
from MakimaDevil.modules.sql.global_bans_sql import is_user_gbanned
from MakimaDevil.modules.sql.afk_sql import is_afk, check_afk_status
from MakimaDevil.modules.sql.users_sql import get_user_num_chats
from MakimaDevil.modules.helper_funcs.chat_status import sudo_plus
from MakimaDevil.modules.helper_funcs.extraction import extract_user
from MakimaDevil import telethn as makimatelethonTelethonClient, KILLERS, DEVILS, ANGELS
...
@makimatelethonTelethonClient.on(
    events.NewMessage(
        pattern="/ginfo ", from_users=(KILLERS or []) + (DEVILS or []) + (ANGELS or [])
    )
)
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' [<a href="https://t.me/Makima_Devil_Updates/17">?</a>]'.format(
            bot.username
        )
...
*What is that health thingy?*
 Come and see [HP System explained](https://t.me/Makima_Devil_Updates/18)
"""
