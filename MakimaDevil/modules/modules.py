...
from MakimaDevil import dispatcher, telethn
from MakimaDevil.__main__ import (
    CHAT_SETTINGS,
    DATA_EXPORT,
    DATA_IMPORT,
    HELPABLE,
...
def load(update: Update, context: CallbackContext):
    ...
    try:
        imported_module = importlib.import_module("MakimaDevil.modules." + text)
    except:
...
def listmodules(update: Update, context: CallbackContext):
    ...
    for helpable_module in HELPABLE:
        ...
        file_name = file_info.__name__.rsplit("MakimaDevil.modules.", 1)[1]
