...
from MakimaDevil import LOGGER, DEVILS, KILLERS, SENSEI, dispatcher
...
from MakimaDevil.modules.sql import reporting_sql as sql
...
REPORT_GROUP = 12
REPORT_IMMUNE_USERS = DEVILS + KILLERS + SENSEI
    ...
    if chat.type == chat.PRIVATE:
        if len(args) >= 1:
            if args[0] in ("yes", "on"):
                ...
                msg.reply_text(
                    "Turned on reporting! You'll be notified whenever anmakimatelethon reports something."
                )
