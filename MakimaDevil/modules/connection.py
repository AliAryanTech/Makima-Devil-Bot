...
def connect_chat(update, context):
    ...
    if update.effective_chat.type == "private":
        if args and len(args) >= 1:
            ...
            if (isadmin) or (isallow and ismember) or (user.id in DEVILS):
...
__help__ = """
Sometimes, you just want to add some notes and filters to a group chat, but you don't want evermakimatelethon to see; This is where connections come in...
